...
sink(paste(chemin,annotfolder,"/",annotname,pays,"_result", ".csv", sep=""))
...
j=1
for (j in 1:songnum){
  doc=read.table(paste(chemin,annotfolder,"/",songname[j],".csv", sep=""),header=TRUE, fill = TRUE,sep = ",", row.names = NULL)
  doc=as.matrix(doc)
  doc = doc[!is.na(doc[,2]),]
  linenumber = nrow(doc)
  ...
  png(file = paste(chemin,annotfolder,"/",annotname,"_",songname[j],"_TP9", ".png", sep=""))
  # Plot the bar chart.
  ...
  maxval= max(AF7[,2:6])
  # Give the chart file a name.
  png(file = paste(chemin,annotfolder,"/",annotname,"_",songname[j],"_AF7", ".png", sep=""))
  # Plot the bar chart.
  ...
  maxval= max(AF8[,2:6])
  # Give the chart file a name.
  png(file = paste(chemin,annotfolder,"/",annotname,"_",songname[j],"_AF8", ".png", sep=""))
  # Plot the bar chart.
  ...
  maxval= max(TP10[,2:6])
  # Give the chart file a name.
  png(file = paste(chemin,annotfolder,"/",annotname,"_",songname[j],"_TP10", ".png", sep=""))
  # Plot the bar chart.
...
###################################normalization and gram############
i=1
j=1

sink(paste(chemin,annotfolder,"/",annotname,pays,"_result", "-norms.csv", sep=""))
cat(paste("",signal,sep=","))
cat("\n")
cat("\n")

numBins=8
Info=matrix(NA,nrow = songnum, ncol = numBins*4*songnum)
line=1
k=0
  ...
  for (j in 1:songnum){
    ...
    for(lop in 1:numBins){
      if(lop==numBins){
        Info[line,hi]= length(TP9[TP9[,2]>= down & TP9[,2]<= (down+deltaTop),2])
        Info[line,hi+8*1]= length(TP9[TP9[,3]>= down & TP9[,3]<= (down+deltaTop),3])
        Info[line,hi+8*2]= length(TP9[TP9[,4]>= down & TP9[,4]<= (down+deltaTop),4])
        Info[line,hi+8*3]= length(TP9[TP9[,5]>= down & TP9[,5]<= (down+deltaTop),5])
        Info[line,hi+8*4]= length(TP9[TP9[,6]>= down & TP9[,6]<= (down+deltaTop),6])
      }else{
        Info[line,hi]= length(TP9[TP9[,2]>= down & TP9[,2]< (down+deltaTop),2])
        Info[line,hi+8*1]= length(TP9[TP9[,3]>= down & TP9[,3]< (down+deltaTop),3])
        Info[line,hi+8*2]= length(TP9[TP9[,4]>= down & TP9[,4]< (down+deltaTop),4])
    ...
    maxval= max(TP9[,2:6])
    # Give the chart file a name.
    png(file = paste(chemin,annotfolder,"/",annotname,"_",songname[j],"_TP9", "-norm.png", sep=""))
    # Plot the bar chart.
    ...
    for(lop in 1:numBins){
      if(lop==numBins){
        Info[line,hi+8*5]= length(AF7[AF7[,2]>= down & AF7[,2]<= (down+deltaTop),2])
        Info[line,hi+8*6]= length(AF7[AF7[,3]>= down & AF7[,3]<= (down+deltaTop),3])
        Info[line,hi+8*7]= length(AF7[AF7[,4]>= down & AF7[,4]<= (down+deltaTop),4])
        Info[line,hi+8*8]= length(AF7[AF7[,5]>= down & AF7[,5]<= (down+deltaTop),5])
        Info[line,hi+8*9]= length(AF7[AF7[,6]>= down & AF7[,6]<= (down+deltaTop),6])
      }else{
        Info[line,hi+8*5]= length(AF7[AF7[,2]>= down & AF7[,2]< (down+deltaTop),2])
        Info[line,hi+8*6]= length(AF7[AF7[,3]>= down & AF7[,3]< (down+deltaTop),3])
        Info[line,hi+8*7]= length(AF7[AF7[,4]>= down & AF7[,4]< (down+deltaTop),4])
    ...
    maxval= max(AF7[,2:6])
    # Give the chart file a name.
    png(file = paste(chemin,annotfolder,"/",annotname,"_",songname[j],"_AF7", "-norm.png", sep=""))
    # Plot the bar chart.
    ...
    for(lop in 1:numBins){
      if(lop==numBins){
        Info[line,hi+8*10]= length(AF8[AF8[,2]>= down & AF8[,2]<= (down+deltaTop),2])
        Info[line,hi+8*11]= length(AF8[AF8[,3]>= down & AF8[,3]<= (down+deltaTop),3])
        Info[line,hi+8*12]= length(AF8[AF8[,4]>= down & AF8[,4]<= (down+deltaTop),4])
        Info[line,hi+8*13]= length(AF8[AF8[,5]>= down & AF8[,5]<= (down+deltaTop),5])
        Info[line,hi+8*14]= length(AF8[AF8[,6]>= down & AF8[,6]<= (down+deltaTop),6])
      }else{
        Info[line,hi+8*10]= length(AF8[AF8[,2]>= down & AF8[,2]< (down+deltaTop),2])
        Info[line,hi+8*11]= length(AF8[AF8[,3]>= down & AF8[,3]< (down+deltaTop),3])
        Info[line,hi+8*12]= length(AF8[AF8[,4]>= down & AF8[,4]< (down+deltaTop),4])
    ...
    maxval= max(AF8[,2:6])
    # Give the chart file a name.
    png(file = paste(chemin,annotfolder,"/",annotname,"_",songname[j],"_AF8", "-norm.png", sep=""))
    # Plot the bar chart.
    ...
    for(lop in 1:numBins){
      if(lop==numBins){
        Info[line,hi+8*15]= length(TP10[TP10[,2]>= down & TP10[,2]<= (down+deltaTop),2])
        Info[line,hi+8*16]= length(TP10[TP10[,3]>= down & TP10[,3]<= (down+deltaTop),3])
        Info[line,hi+8*17]= length(TP10[TP10[,4]>= down & TP10[,4]<= (down+deltaTop),4])
        Info[line,hi+8*18]= length(TP10[TP10[,5]>= down & TP10[,5]<= (down+deltaTop),5])
        Info[line,hi+8*19]= length(TP10[TP10[,6]>= down & TP10[,6]<= (down+deltaTop),6])
      }else{
        Info[line,hi+8*15]= length(TP10[TP10[,2]>= down & TP10[,2]< (down+deltaTop),2])
        Info[line,hi+8*16]= length(TP10[TP10[,3]>= down & TP10[,3]< (down+deltaTop),3])
        Info[line,hi+8*17]= length(TP10[TP10[,4]>= down & TP10[,4]< (down+deltaTop),4])
    ...
    maxval= max(TP10[,2:6])
    # Give the chart file a name.
    png(file = paste(chemin,annotfolder,"/",annotname,"_",songname[j],"_TP10", "-norm.png", sep=""))
    # Plot the bar chart.
    ...
    for(lop in 1:19){
      ...
      png(file = paste(chemin,annotfolder,"/",annotname,"_",songname[j],"_", area ,"_", signal[signallop], "--norm.png", sep=""))
...
##draw for all gram
    ...
    signallop=1
    B2=NULL
    png(file = paste(chemin,annotfolder,"/",annotname,"_",songname[j],"_", area ,"--norm.png", sep=""), width=1280, height =480)
    for(lop in 1:20){
      if(lop==6){
