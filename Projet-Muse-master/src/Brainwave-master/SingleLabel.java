...
public class SingleLabel {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Instances data = ReadFile("/Users/raharjo/Downloads/PH2dataset.arff");  
        Instances train = null;  //this is train data if you define the test data
        Instances test = null;
        //change this directory if you use train and test
...
//        for(int a= 0;a<filters.getOptions().length;a++)
//            System.out.print(filters.getOptions()[a] + "    ");

//declare the classifier
       Classifier scheme = new MultilayerPerceptron();
...
//        System.out.println(scheme.toString() + "\n\n");
        ...
        //evaluation methods, 1 for cross validation (you need to put a test parameter, but it will not be considered) 
            //and 2 for training-testing data, 
        //further info : see the function
        Evaluation eval = Evaluate(1,data,test,scheme);
